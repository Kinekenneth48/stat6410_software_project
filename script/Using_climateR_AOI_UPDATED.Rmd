...
A correcetion to the previous example, this time with the correct specifications for the area of interest.
...
A interactive shiny app, that allows for user drawn maps, will return an multipolygon. There are difficulties in saving directly to envionment, A suggestiong of saving as a file and following code below to read file of object and visually see object.
...
Easily able to return polygon of Utah and Cache County by specifing parameters. A Map is returned to inspect that the specified object is correct.
...
Easily abe to return polygon of Utah and every county associated with Utah. A Map is returned to inspect that the specified object is correct.
